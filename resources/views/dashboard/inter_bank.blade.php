                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{route('inter.transfer')}}" method="POST" id="transferForm">
                                    @csrf
                                    <div id="content-one">
                                        <div class="form-group mb-3">
                                            <label>Amount</label>
                                            <input id="transfer_amount" type="number" name="amount" class="form-control" placeholder="Enter Amount" required>
                                        </div>
                                        <div class="form-group mb-3">
                                            <label>Holder Name</label>
                                            <input id="holder_name" type="text" name="holder_name" class="form-control" placeholder="Holder Name" required>
                                        </div>
                                        <div class="form-group mb-3">
                                            <label>Account Number</label>
                                            <input id="account_number" type="text" name="account_number" class="form-control" placeholder="Account Number" required>
                                        </div>
                                        <div class="form-group mb-3">
                                            <label>Bank Name</label>
                                            <input id="bank_name" type="text" name="bank_name" class="form-control" placeholder="Bank Name" required>
                                        </div>
                                        <div class="form-group mb-3">
                                            <label>IBAN Number</label>
                                            <input id="iban_number" type="text" name="iban_number" class="form-control" placeholder="IBAN Number" required>
                                        </div>
                                        <div class="form-group mb-3">
                                            <label>SWIFT/BIC Code</label>
                                            <input id="swift_code" type="text" name="swift_code" class="form-control" placeholder="SWIFT/BIC Code" required>
                                        </div>
                                        <div class="form-group mb-3">
                                            <label>Bank Address</label>
                                            <textarea name="bank_address" class="form-control" placeholder="Bank Address" required></textarea>
                                        </div>
                                        <div class="form-group mb-3">
                                            <label>Country</label>
                                        ...
                                        <button type="button" id="startVerification" class="btn btn-primary w-100">Proceed</button>
                                    </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="input-pin-grid">
                                                        <input type="number" id="otpInput" name="otp" class="form-control form-control-lg" required>
                                                        <div id="otpError" class="text-danger mt-2" style="display: none;"></div>
                                                    </div>
                                                    <button type="button" id="verifyOtp" class="btn btn-primary w-100 mt-3">Verify OTP</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="input-pin-grid">
                                                        <input type="number" id="ccicInput" name="ccic_code" class="form-control form-control-lg" required>
                                                        <div id="ccicError" class="text-danger mt-2" style="display: none;"></div>
                                                    </div>
                                                    <button type="button" id="verifyCcic" class="btn btn-primary w-100 mt-3">Verify CCIC Code</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="input-pin-grid">
                                                        <input type="number" id="intInput" name="int_code" class="form-control form-control-lg" required>
                                                        <div id="intError" class="text-danger mt-2" style="display: none;"></div>
                                                    </div>
                                                    <button type="button" id="verifyInt" class="btn btn-primary w-100 mt-3">Complete Transfer</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    startBtn.addEventListener('click', function() {
        ...
        const ibanNumber = document.getElementById('iban_number').value;
        const swiftCode = document.getElementById('swift_code').value;
        
        if (!amount || !holderName || !accountNumber || !bankName || !ibanNumber || !swiftCode) {
