                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{route('wise.transfer')}}" method="POST" id="transferForm">
                                    @csrf
                                    <div id="content-one">
                                        ...
                                        <div class="form-group mb-3">
                                            <label>Email</label>
                                            <input id="wise_email" type="email" name="email" class="form-control"
                                                placeholder="Wise Email Address" value="{{Auth::user()->email}}"
                                                required>
                                        </div>
                                        <input type="hidden" name="routing" value="wise">
...
<script>
    ...
    startBtn.addEventListener('click', function() {
        ...
        const email = document.getElementById('wise_email').value;
        ...
        if (!email) {
            alert('Please enter your Wise email address.');
            return;
        }
